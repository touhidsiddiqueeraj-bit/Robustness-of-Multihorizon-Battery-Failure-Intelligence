...
Figure~\ref{fig:shap} confirms this via SHAP feature importance analysis. Under clean laboratory conditions, \(V_{\text{min}}\) is the dominant feature driving failure predictions. Under perturbation, its importance is further amplified while all other features shift in distribution, causing the calibrated probability surface to map to incorrect risk levels.
