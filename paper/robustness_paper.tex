...
Raw discharge curves from NASA .mat files are truncated at a randomly sampled DoD fraction to simulate partial cycling. Features are recomputed from the truncated signal. Temperature noise is added as \(\mathcal{N}(0, \sigma_s)\) to raw measurements before averaging.
...
At \(H=20\), ECE jumps from 0.031 to 0.277--0.293---a nine-fold increase---while AUC drops from 0.985 to 0.65--0.74 (Table~\ref{tab:h20}). The degradation saturates at Severity~1: even minimal partial cycling causes near-maximal calibration loss.
...
\midrule
Clean & --- & 0.031 & --- & 0.985 \\
S1 (mild) & 0.226$\pm$0.004 & 0.286$\pm$0.010 & 0.062$\pm$0.036 & 0.741$\pm$0.009 \\
S2 (mod.) & 0.212$\pm$0.006 & 0.288$\pm$0.011 & 0.065$\pm$0.020 & 0.681$\pm$0.004 \\
S3 (sev.) & 0.204$\pm$0.005 & 0.277$\pm$0.010 & 0.054$\pm$0.025 & 0.674$\pm$0.006 \\
S4 (aggr.) & 0.220$\pm$0.004 & 0.293$\pm$0.014 & 0.061$\pm$0.022 & 0.652$\pm$0.005 \\
\bottomrule
\end{tabular}
\end{table}
...
Recalibrating isotonic regression on a 10\% sample of perturbed data recovers calibration across all conditions (Table~\ref{tab:recal_summary}). ECE drops to 0.05--0.09---a 75--81\% reduction. The recovery is consistent regardless of severity or horizon.

\begin{table}[htbp]
\centering
\caption{Recalibration recovery across all horizons.}
\label{tab:recal_summary}
\begin{tabular}{@{}lccc@{}}
\toprule
Horizon & Clean ECE & Perturbed range & Recalibrated range \\
\midrule
10 & 0.010 & 0.272--0.313 & 0.051--0.069 \\
20 & 0.031 & 0.277--0.293 & 0.054--0.065 \\
30 & 0.013 & 0.288--0.317 & 0.068--0.083 \\
50 & 0.023 & 0.331--0.381 & 0.072--0.085 \\
\bottomrule
\end{tabular}
\end{table}
...
\item Recalibration on a 10\% operational sample recovers 75--81\% of the calibration gap (ECE 0.05--0.09), providing a practical path to field deployment.
\end{enumerate}
