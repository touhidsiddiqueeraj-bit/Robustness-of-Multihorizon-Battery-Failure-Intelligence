...
\caption{Reliability diagrams showing calibration quality under clean baseline conditions. Perfect calibration follows the diagonal; deviations reveal systematic bias.}
...
Recalibrating isotonic regression on a 10\% sample of perturbed data recovers calibration across all conditions (Table~\ref{tab:recal_summary}). ECE drops to 0.06--0.09---a 71--88\% reduction (evaluated on held-out data). The recovery is consistent regardless of severity or horizon.
