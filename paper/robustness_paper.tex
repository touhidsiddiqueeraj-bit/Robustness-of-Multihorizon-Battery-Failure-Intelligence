...
Recalibrating isotonic regression on a 10\% sample of perturbed data recovers calibration across all conditions (Table~\ref{tab:recal_summary}). ECE drops to 0.05--0.09---a 74--91\% reduction. The recovery is consistent regardless of severity or horizon.
...
\item Discrimination degrades moderately (AUC 0.99--1.00 to 0.63--0.76). The feature extractor generalizes better than the calibrator.
 \item Recalibration on a 10\% operational sample recovers 74--91\% of the calibration gap (ECE 0.05--0.09), providing a practical path to field deployment.
\end{enumerate}
